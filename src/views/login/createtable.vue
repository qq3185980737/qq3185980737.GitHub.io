<template>
  ...
  <div :style="{width:videoBox}" > 
    ...
    <el-button type="primary" @click="openqjmm">权限管理</el-button>
...
<el-button type="primary" @click="craete1" >建立上下级关系</el-button>
    ...
    <el-dialog title="" :visible.sync="Visible6" width="280px" style="z-index: 20;" class="thisblack-bgc" :model='false'>
      ...
      <p>部门查看</p>
      <el-card style="margin-top: 20px">
    <!--    <el-dialog title="流程图" :visible.sync="Visible8" width="1100px" style="z-index: 20;" class="thisblack-bgc" :model='false'>
          选择关联表1
         <el-select 
          v-model="Groups1"
          placeholder="请选择"
      ...
      <el-button type="primary" @click="changeindex2(0)">立即查找</el-button>
<el-button type="primary" @click="changeindex1(0)">立即修改</el-button>
<el-button type="primary" @click="changeindex(0)">立即发布</el-button>
      <el-button type="primary" @click="changeindex3(0)">添加</el-button>
<el-button type="primary" @click="changeindex4(0)">立即查找</el-button>
</el-dialog>-->
...
<element-table1 :list="list" :page-size="10" :columns="columnss" ref="elementTable"></element-table1>
 
</el-card>
<el-card style="margin-top: 20px" v-if=Visible4>
...
this.Visible9=true
    ...
    tableshowq() {      
          ...
          loginAxios("/tableshowq",this.kj).then(result=>{
          if (result.data.code===9000){            
...
console.log(this.list2)
     ...
     var mark2={field:"",value:""}
      ...
      loginAxios("/ttbiaodan1",this.kj,JSON.stringify(mark11)).then(result=>{
          if (result.data.code==9000){     
            this.Visible1=false
          this.Visible2=false
            this.$message.succuss("victory");
  ...
  updata1(updata){
    ...
    } console.log("hcfxjhguct"+JSON.stringify(mark11))
     loginAxios("/query",this.kj,JSON.stringify(mark11)).then(result=>{
          if (result.data.code==9000){     
            this.Visible3=false
